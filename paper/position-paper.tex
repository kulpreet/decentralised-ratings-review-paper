...
marketplaces generate a key pair for each vendor that lists on the
marketplace and signs the private key with its own ``certification
key''. This way[HERE...]
