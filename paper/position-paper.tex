...
\begin{itemize}
\item we are not solving the problem of identity, i.e\@. we don't need
  the marketplace and vendor public keys to be discoverable by just
  using the vendor or marketplace identity.
\end{itemize}
...
\bibitem{wellknown}
  \textit{Defining Well-Known Uniform Resource Identifiers (URIs)}
