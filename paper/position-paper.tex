...
$\texttt{Payment record}, \texttt{PR} = (C, V, A, RR)$
...
\item[$H$, Hash]: The hash of all of the above, $H(C, V, A, R, Rv, Dr, PoPR)$
\end{description}

$\texttt{Review Record}, \texttt{RR} = (PoPR, H, E_v(Pve, (C, V, A, R, Rv, Dr)))$
